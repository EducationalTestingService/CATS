...
vocab_path_en = "../data/embeddings/en.vocab"
vecs_path_en = "../data/embeddings/en.vectors"

vocab_path_lang = "../data/embeddings/hr.vocab"
vecs_path_lang = "../data/embeddings/hr.vectors"
...
MODEL_HOME = "../data/models/cats_pretrained" # for TLT, use "data/models/tlt_pretrained"
